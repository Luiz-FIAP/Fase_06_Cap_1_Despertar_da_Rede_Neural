...
const char* WIFI_SSID = "Luiz Henrique "; //celular Apple não funciona, porque ele não tem 2.4GHz
const char* WIFI_PASS = "lauren131928";
...
static auto midRes = esp32cam::Resolution::find(416, 416);
...
void serveJpg()
{
  ...
  Serial.printf("CAPTURE OK %dx%d %db", frame->getWidth(), frame->getHeight(), static_cast<int>(frame->size()));
